...
const Login = ({navigation}) => {
  ...
  return (
    ...
    <View style={{flexDirection:'row', marginTop:-185}}>
          <Texto texto={'Novo por aqui? '} tamanhoFonte={20}  fonte={'opensans'}/>
        <Text onPress={()=> navigation.navigate('Cadastro')} style={{color:'blue', fontSize:20, fontFamily:'opensans'}}>Cadastre-se</Text>
